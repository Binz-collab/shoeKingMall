...
//import { RegisterNewCard } from './components/RegisterNewCard'
import './App.css'
      ...
      <Routes>
        <Route path="/" element={
          <>
            ...
            <ProductList products={products} clickedButtons={clickedButtons} onClickAddCart={onClickAddCart} onClickBuy={onClickBuy}/> 
          </>
        }/>
      </Routes>
